...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Prospect <small>Form Update</small></h2>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{Form::date('prospect_date', \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $prospect->prospect_date)->format('Y-m-d'))}}
                    </div>
                </div>
                <div class="form-group">
