...
<body class="nav-md">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-bar-chart"></i> Prospects <span class="fa fa-chevron-down"></span></a>
                                ...
                                <li><a><i class="fa fa-car"></i> Units <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{route('pendors.index')}}">Vendors</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Leasings <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                        ...
                        <h3>Live On</h3>
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-sitemap"></i> Branchs <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('branches.index')}}">Branchs</a></li>
    ...
    <script src="{{ asset('build/js/mycustom.js') }}"></script>
</body>
</html>
